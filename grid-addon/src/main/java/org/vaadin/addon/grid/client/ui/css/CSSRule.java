package org.vaadin.addon.grid.client.ui.css;
...
public class CSSRule {
    ...
    /*-{
        ...
        for(var i = 0; i < sheets.length; i++) {
            ...
            if(sheet.href && sheet.href.indexOf("VAADIN/themes")>-1) {
                this.@org.vaadin.addon.grid.client.ui.css.CSSRule::rules = @org.vaadin.addon.grid.client.ui.css.CSSRule::searchForRule(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Z)(sheet, selector, deep);
                return;
            }
        }
        this.@org.vaadin.addon.grid.client.ui.css.CSSRule::rules = [];
    }-*/;
    ...
    /*-{
        ...
        if(deep && sheet.imports.length > 0) {
            for(var i=0; i < sheet.imports.length; i++) {
                var imports = @org.vaadin.addon.grid.client.ui.css.CSSRule::searchForRule(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Z)(sheet.imports[i], selector, deep);
        ...
        for(var i=0; i<j; i++) {
            ...
            if(r.type == 1 || sheet.imports) {
                ...
                var imports = @org.vaadin.addon.grid.client.ui.css.CSSRule::searchForRule(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Z)(r.styleSheet, selector, deep);
                allMatches.concat(imports);
            }
        }
    ...
    /*-{
        this.@org.vaadin.addon.grid.client.ui.css.CSSRule::rules[0].style[propertyName] = propertyValue;
    }-*/;
    ...
    for(var i = 0; i < sheets.length; i++) {
        ...
        if(sheet.href && sheet.href.indexOf("VAADIN/themes")>-1) {
            ...
            rule.@org.vaadin.addon.grid.client.ui.css.CSSRule::rules = [r];
        }
    }
    }-*/;
